...
export interface ERC1363Utils$Type {
  "_format": "hh-sol-artifact-1",
  "contractName": "ERC1363Utils",
  "sourceName": "@openzeppelin/contracts/token/ERC20/utils/ERC1363Utils.sol",
  "abi": [
    {
      "inputs": [
        {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<ERC1363Utils$Type["abi"]>>;
  export function deployContract(
    contractName: "@openzeppelin/contracts/token/ERC20/utils/ERC1363Utils.sol:ERC1363Utils",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<ERC1363Utils$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<ERC1363Utils$Type["abi"]>;
